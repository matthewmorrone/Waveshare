 ...
 * Size: 128 px
 * Bpp: 4
 * Opts: --font /Users/matthewmorrone/Documents/Arduino/libraries/lvgl/tests/src/test_files/fonts/Montserrat-Bold.ttf --size 128 --bpp 4 --format lvgl --range 0x20,0x30-0x3A --no-compress -o /Users/matthewmorrone/Documents/Arduino/Waveshare/Waveform/src/fonts/montserrat_bold_128.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_BOLD_128
#define MONTSERRAT_BOLD_128 1
#endif

#if MONTSERRAT_BOLD_128
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x27, 0xac, 0xdc, 0xb9, 0x51, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4c, 0xff,
    ...
    0x0, 0x0, 0x48, 0xce, 0xff, 0xdb, 0x62, 0x0,
    0x0, 0x0, 0x0
};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1391, .box_w = 78, .box_h = 93, .ofs_x = 4, .ofs_y = -2},
    {.bitmap_index = 3627, .adv_w = 803, .box_w = 40, .box_h = 90, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5427, .adv_w = 1208, .box_w = 72, .box_h = 92, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8739, .adv_w = 1212, .box_w = 73, .box_h = 91, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 12061, .adv_w = 1411, .box_w = 85, .box_h = 90, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 15886, .adv_w = 1219, .box_w = 72, .box_h = 91, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 19162, .adv_w = 1305, .box_w = 75, .box_h = 93, .ofs_x = 4, .ofs_y = -2},
    {.bitmap_index = 22650, .adv_w = 1270, .box_w = 73, .box_h = 90, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 25935, .adv_w = 1352, .box_w = 76, .box_h = 93, .ofs_x = 4, .ofs_y = -2},
    {.bitmap_index = 29469, .adv_w = 1305, .box_w = 75, .box_h = 93, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 32957, .adv_w = 537, .box_w = 26, .box_h = 71, .ofs_x = 4, .ofs_y = -1}
};
...
{
    -7, -7, -18, -7, -18, -9, -9, -18,
    -16, -46, -13, -76, 18, -7, 15, -9,
    -9, -9, -22, -7, -36, 18, -13, -118,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_bold_128 = {
#else
lv_font_t montserrat_bold_128 = {
#endif
